...
## TODO: разделение графиков по проектам

Необходимо предусмотреть способ различать графики и метрики от разных проектов (например, фильтрация по проекту, разметка лейблами или раздельные панели/дашборды). Лучше сделать разные дашборды.
